...
export default function Root({period}) { 
  ...
  const text = [
    " i got my bacaloria degree in 2019 physic option . in this period i was interested about math and physics and from time to time i play some vedio games , for that reasen i was always asking my self how to crate a vedio game but i wasn't that match interested but 2020 was the surprise    ",
    "2022 i took the most important step in my life , i passed the ENSA concour and i get my place on it , then my life start to create it self , the first your at ensa we studied some programming languages like c , matlab and mapple i'feel really confortable when i code with them especialy c so i started to love this domain .",
    " 2021 also was a very important part in my formation because i chosed the software engeenering as a main domain  , after discovering that it's the only domain that i can spend a lot of time doing it without feeling tired . ",
    " 2022 i'm beeing love with mern stack web develppment , to improve my skills i create meny web apps you can find them on my work page ,  ",
  ];
